  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 md:py-24">
      ...
      <header className="mb-10 flex flex-wrap items-end justify-between gap-6 border-b border-[var(--rule)] pb-8">
        <div>
          <p className="mb-3 font-mono text-[11px] uppercase tracking-[0.18em] text-[var(--g-machine)]">{eyebrow}</p>
      ...
      {/* the manual */}
      <details className="group mt-10 border-t border-[var(--rule)] pt-5">
