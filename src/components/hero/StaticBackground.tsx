...
const ORBS = [
  { left: '12%', top: '18%', size: 280, tint: 'var(--orb-amber)', dur: '14s', delay: '0s' },
  { left: '74%', top: '12%', size: 220, tint: 'var(--orb-patina)', dur: '18s', delay: '-3s' },
  { left: '58%', top: '62%', size: 320, tint: 'var(--orb-rust)', dur: '22s', delay: '-7s' },
  { left: '22%', top: '70%', size: 240, tint: 'var(--orb-patina)', dur: '16s', delay: '-11s' },
  { left: '88%', top: '48%', size: 200, tint: 'var(--orb-amber)', dur: '20s', delay: '-5s' },
]
  ...
  return (
    <div className="absolute inset-0 overflow-hidden" aria-hidden="true">
      ...
      <div
        ...
        style={{
          background: `
            radial-gradient(circle at 18% 42%, var(--orb-amber) 0%, transparent 52%),
            radial-gradient(circle at 82% 58%, var(--orb-patina) 0%, transparent 50%)
          `,
        }}
      />
