        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {project.techStack.slice(0, 4).map(tech => (
              <span
                key={tech}
                className="text-xs px-2 py-1 bg-[var(--bar-track)]/80 rounded-full text-[var(--ink-soft)]"
              >
                {tech}
              </span>
            ))}
            {project.techStack.length > 4 && (
              <span className="text-xs px-2 py-1 text-[var(--ink-faint)]">
          ...
          {project.metrics && (
            <div className="grid grid-cols-2 gap-2 pt-4 border-t border-[var(--rule)]">
