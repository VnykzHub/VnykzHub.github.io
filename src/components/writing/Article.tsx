    ...
    >
      {prev ? (
        <Link
          ...
          className="group rounded-xl border border-[var(--card-border)] bg-[var(--card-bg)] p-5 transition-colors hover:border-accent-cyan"
        >
          ...
          <span className="mt-2 block font-sans text-base font-semibold text-[var(--heading)] group-hover:text-accent-cyan">
            {prev.title}
          </span>
        </Link>
      ) : (
      ...
      {next && (
        <Link
          ...
          className="group rounded-xl border border-[var(--card-border)] bg-[var(--card-bg)] p-5 text-right transition-colors hover:border-accent-cyan sm:col-start-2"
        >
